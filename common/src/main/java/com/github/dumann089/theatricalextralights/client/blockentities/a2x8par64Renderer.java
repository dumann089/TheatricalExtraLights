...
import com.github.dumann089.theatricalextralights.blockentities.a2x8par64BlockEntity;
...
public class a2x8par64Renderer extends ExtraLightsRenderer<a2x8par64BlockEntity> {
    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;
    public a2x8par64Renderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(a2x8par64BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
@Override
public void beforeRenderBeam(a2x8par64BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
    if (blockEntity.getIntensity() > 0) {
        LazyRenderers.addLazyRender(new LazyRenderers.LazyRenderer() {
            ...
            public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                ...
                float[][] beamPositions = {
                    { 1.67F, 0.671F, 0.218F },
                    { 1.339F, 0.671F, 0.218F },
                    { 1.02F, 0.671F, 0.218F },
                        { 0.68F, 0.671F, 0.218F },
                        { 0.381F, 0.671F, 0.218F },
                        { 0.045F, 0.671F, 0.218F },
                        { -0.270F, 0.671F, 0.218F },
                        { -0.607F, 0.671F, 0.218F },
                        { 1.67F, 0.33F, 0.218F },
                        { 1.339F, 0.33F, 0.218F },
                        { 1.02F, 0.33F, 0.218F },
                        { 0.68F, 0.33F, 0.218F },
    ...
    @Override
    public void preparePoseStack(a2x8par64BlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
        //#region Fixture Hanging
