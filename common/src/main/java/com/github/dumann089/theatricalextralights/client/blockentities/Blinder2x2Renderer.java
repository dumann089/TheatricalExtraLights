...
public class Blinder2x2Renderer extends ExtraLightsRenderer<Blinder2x2BlockEntity> {
    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;
    public Blinder2x2Renderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(Blinder2x2BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
//        poseStack.mulPose(Axis.XP.rotationDegrees(180));
    ...
    public void beforeRenderBeam(
            Blinder2x2BlockEntity blockEntity,
            PoseStack poseStack,
