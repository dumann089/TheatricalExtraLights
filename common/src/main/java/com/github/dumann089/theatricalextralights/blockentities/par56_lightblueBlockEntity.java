...
public class par56_lightblueBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {

    private final int fixedGobo = 0;
    private final int fixedZoom = 255;
    private final float fixedGoboRotation = 0f;

    public par56_lightblueBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.PAR56_LIGHTBLUE.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public Fixture getFixture() {
        return Fixtures.PAR56_LIGHTBLUE.get();
    }
    ...
    @Override
    public String getModelName() { return "Par56 Lightblue"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_LIGHTBLUE.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.par56_lightblue"; }
