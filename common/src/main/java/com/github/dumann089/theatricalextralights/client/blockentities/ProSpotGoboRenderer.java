...
public class ProSpotGoboRenderer extends ExtraLightsFixtureRenderer<ProSpotGoboBlockEntity> {
    ...
    private final java.util.Map<ProSpotGoboBlockEntity, GoboWheelAnimator> goboAnimators = new java.util.WeakHashMap<>();
    ...
    public ProSpotGoboRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    private float[] getThrottledStructuralTransforms(ProSpotGoboBlockEntity be, BlockState state) {
    ...
    @Override
    public void renderModel(ProSpotGoboBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            ProSpotGoboBlockEntity blockEntity,
            PoseStack poseStack,
