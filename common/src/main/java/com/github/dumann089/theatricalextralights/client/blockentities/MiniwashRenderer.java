...
import com.github.dumann089.theatricalextralights.blockentities.MiniwashBlockEntity;
...
public class MiniwashRenderer extends ExtraLightsRenderer<MiniwashBlockEntity> {
    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;

    public MiniwashRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(MiniwashBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    @Override
    public void beforeRenderBeam(MiniwashBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.5F, 0.518F, 0.328F);
                    Matrix4f m = poseStack.last().pose();
                    Matrix3f normal = poseStack.last().normal();
                    addVertex(beamConsumer, m, normal, r, g, b, a, -0.125f, 0.14375f , 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,  0.125f, 0.14375f, 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a, 0.125f, -0.14375f,0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,-0.125f, -0.14375f, 0f);
                    poseStack.popPose();
