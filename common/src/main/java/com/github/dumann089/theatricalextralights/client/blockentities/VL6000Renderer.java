...
import com.github.dumann089.theatricalextralights.blockentities.VL6000BlockEntity;
...
public class VL6000Renderer extends ExtraLightsFixtureRenderer<VL6000BlockEntity> {

    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;

    private final Double beamOpacity = TheatricalConfig.INSTANCE.CLIENT.beamOpacity;
    private static final Vec3 LENS_OFFSET = new Vec3(0.5f, 0.812F, 0.275F);
    ...
    @Override
    public void renderModel(VL6000BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    @Override
    public void beforeRenderBeam(VL6000BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
