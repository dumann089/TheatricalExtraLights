...
import com.github.dumann089.theatricalextralights.blockentities.verticalscrollerBlockEntity;
...
public class verticalscrollerRenderer extends ExtraLightsRenderer<verticalscrollerBlockEntity> {
    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;
    public verticalscrollerRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(verticalscrollerBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
@Override
public void beforeRenderBeam(verticalscrollerBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
        ...
        LazyRenderers.addLazyRender(new LazyRenderers.LazyRenderer() {
            ...
            public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                ...
                float[][] beamPositions = {
                            ...
                            {0.687F, 0.765F, 0.468F},   // Beam 2
                            {0.687F, 1.140F, 0.468F},   // Beam 3
                            {0.687F, 1.515F, 0.468F},   // Beam 4
                            {0.25F, 0.390F, 0.468F},   // Beam 5
                            {0.25F, 0.765F, 0.468F},   // Beam 6
                            {0.25F, 1.140F, 0.468F},   // Beam 7
                            {0.25F, 1.515F, 0.468F},   // Beam 8
                };
    ...
    @Override
    public void preparePoseStack(verticalscrollerBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
        //#region Fixture Hanging
