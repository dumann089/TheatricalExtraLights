...
public class MiniSpotGobosFixture extends Fixture {
    ...
    private static final ResourceLocation PAN_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/minispot/minispot_pan");
    private static final ResourceLocation STATIC_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/minispot/minispot_static");

    private final float[] tiltRotation = new float[]{0.5F, 0.406F, 0.491F};
    private final float[] panRotation = new float[]{0.5F, 0.132F, 0.5F};
