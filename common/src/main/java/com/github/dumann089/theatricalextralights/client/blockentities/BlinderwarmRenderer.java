...
public class BlinderwarmRenderer extends ExtraLightsRenderer<BlinderwarmBlockEntity> {
    ...
    @Override
    public void renderModel(BlinderwarmBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
//        poseStack.mulPose(Axis.XP.rotationDegrees(180));
    ...
    public void beforeRenderBeam(
            BlinderwarmBlockEntity blockEntity,
            PoseStack poseStack,
