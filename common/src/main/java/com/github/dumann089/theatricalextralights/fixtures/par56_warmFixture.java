...
public class par56_warmFixture extends Fixture {
    ...
    private static final ResourceLocation TILT_MODEL = new ResourceLocation(TheatricalExtraLights.MOD_ID, "block/par56_fountain/par56_warm_tilt");
