...
public class par56_warmBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {
    ...
    public Fixture getFixture() {
        return Fixtures.PAR56_WARM.get();
    }
    ...
    @Override
    public String getModelName() { return "Par56 WARM"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_WARM.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.par56_warm"; }
