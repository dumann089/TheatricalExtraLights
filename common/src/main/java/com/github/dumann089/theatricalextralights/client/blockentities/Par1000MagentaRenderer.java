...
import com.github.dumann089.theatricalextralights.blockentities.Par1000MagentaBlockEntity;
...
public class Par1000MagentaRenderer extends ExtraLightsFixtureRenderer<Par1000MagentaBlockEntity> {
    ...
    public Par1000MagentaRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(Par1000MagentaBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            Par1000MagentaBlockEntity blockEntity,
            PoseStack poseStack,
    ...
    @Override
    public void preparePoseStack(Par1000MagentaBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
