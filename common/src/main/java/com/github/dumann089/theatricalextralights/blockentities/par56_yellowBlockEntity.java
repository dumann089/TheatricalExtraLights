...
public class par56_yellowBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {
    ...
    @Override
    public String getModelName() { return "Par56 Yellow"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_YELLOW.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.PAR56_YELLOW"; }
