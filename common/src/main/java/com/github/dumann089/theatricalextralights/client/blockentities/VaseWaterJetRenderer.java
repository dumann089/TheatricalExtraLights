...
import com.github.dumann089.theatricalextralights.blockentities.VaseWaterJetBlockEntity;
...
public class VaseWaterJetRenderer extends ExtraLightsRenderer<VaseWaterJetBlockEntity> {
    ...
    public VaseWaterJetRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(VaseWaterJetBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
