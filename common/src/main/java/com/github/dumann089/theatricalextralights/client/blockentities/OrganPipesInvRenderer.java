...
public class OrganPipesInvRenderer extends ExtraLightsRenderer<OrganPipesInvBlockEntity> {
    ...
    private static final double[] HEIGHT_MULTIPLIERS = {
            1.0, 0.9, 0.8, 0.7, 0.6, 0.7, 0.8, 0.9, 1.0
    };

    public OrganPipesInvRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(OrganPipesInvBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
