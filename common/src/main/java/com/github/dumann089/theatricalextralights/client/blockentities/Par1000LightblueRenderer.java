...
import com.github.dumann089.theatricalextralights.blockentities.Par1000LightblueBlockEntity;
...
public class Par1000LightblueRenderer extends ExtraLightsFixtureRenderer<Par1000LightblueBlockEntity> {
    ...
    public Par1000LightblueRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(Par1000LightblueBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            Par1000LightblueBlockEntity blockEntity,
            PoseStack poseStack,
