...
public class VerticalbarRenderer extends ExtraLightsRenderer<VerticalbarBlockEntity> {
    ...
    @Override
    public void renderModel(VerticalbarBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
//        poseStack.mulPose(Axis.XP.rotationDegrees(180));
    ...
    @Override
    public void beforeRenderBeam(VerticalbarBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
        if(blockEntity.getIntensity() > 0){
            LazyRenderers.addLazyRender(new LazyRenderers.LazyRenderer() {
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    addVertex(builder, m, normal, r, g, b, a, -0.125f, 1.4375f , 0f);
                    addVertex(builder, m, normal, r, g, b, a,  0.125f, 1.4375f, 0f);
                    addVertex(builder, m, normal, r, g, b, a, 0.125f, -1.4375f,0f);
                    addVertex(builder, m, normal, r, g, b, a,-0.125f, -1.4375f, 0f);
                    ...
                    renderLightBeam(builder, poseStack, blockEntity, partialTicks, alpha, 0.125f, 1.4375f, beamLength, color);
                    poseStack.popPose();
                }
    ...
    @Override
    public void preparePoseStack(VerticalbarBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
        //#region Fixture Hanging
        poseStack.translate(0.5F, 0, .5F);
        if(isHanging){
            Direction hangDirection = blockState.getValue(HangableBlock.HANG_DIRECTION);
