...
public class WaterJetConeRenderer extends ExtraLightsRenderer<WaterJetConeBlockEntity> {
    ...
    @Override
    public void renderModel(WaterJetConeBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
