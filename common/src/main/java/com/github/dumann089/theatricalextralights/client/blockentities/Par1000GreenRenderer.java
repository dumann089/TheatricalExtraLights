...
import com.github.dumann089.theatricalextralights.blockentities.Par1000GreenBlockEntity;
...
public class Par1000GreenRenderer extends ExtraLightsFixtureRenderer<Par1000GreenBlockEntity> {
    ...
    public Par1000GreenRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(Par1000GreenBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            Par1000GreenBlockEntity blockEntity,
            PoseStack poseStack,
