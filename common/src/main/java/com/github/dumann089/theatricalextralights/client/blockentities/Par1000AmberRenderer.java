...
public class Par1000AmberRenderer extends ExtraLightsFixtureRenderer<Par1000AmberBlockEntity> {
    ...
    public Par1000AmberRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(Par1000AmberBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    private static final float MIN_ANGLE_DEG = 8.0f;
    private static final float MAX_ANGLE_DEG = 8.0f;

    @Override
    public void beforeRenderBeam(
            Par1000AmberBlockEntity blockEntity,
            PoseStack poseStack,
