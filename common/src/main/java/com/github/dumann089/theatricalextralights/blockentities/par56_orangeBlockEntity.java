...
public class par56_orangeBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {

    private final int fixedGobo = 0;
    private final int fixedZoom = 255;
    private final float fixedGoboRotation = 0f;

    public par56_orangeBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.PAR56_ORANGE.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public Fixture getFixture() {
        return Fixtures.PAR56_ORANGE.get();
    }
    ...
    @Override
    public String getModelName() { return "Par56 Orange"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_ORANGE.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.par56_orange"; }
