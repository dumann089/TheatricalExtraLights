...
public class Beam7RRenderer extends ExtraLightsFixtureRenderer<Beam7RBlockEntity> {
    ...
    public Beam7RRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(Beam7RBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    private static final Vec3 LENS_OFFSET = new Vec3(0.5f, 0.781f, 0.2f);
    private static final float MIN_ANGLE_DEG = 1.0f;
    private static final float MAX_ANGLE_DEG = 15.0f;

    @Override
    public void beforeRenderBeam(
            Beam7RBlockEntity blockEntity, PoseStack basePoseStack, VertexConsumer vertexConsumer,
    ...
    @Override
    public void preparePoseStack(Beam7RBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
