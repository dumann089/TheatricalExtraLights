...
import com.github.dumann089.theatricalextralights.blockentities.x8par_lightblueBlockEntity;
...
public class x8par_lightblueRenderer extends ExtraLightsRenderer<x8par_lightblueBlockEntity> {
    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;
    public x8par_lightblueRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(x8par_lightblueBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
//        poseStack.mulPose(Axis.XP.rotationDegrees(180));
    ...
    @Override
    public void beforeRenderBeam(x8par_lightblueBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.5, 0.62f, 0.31f);
                    Matrix4f m = poseStack.last().pose();
                    Matrix3f normal = poseStack.last().normal();
                    addVertex(beamConsumer, m, normal, r, g, b, a, -1.440625f, 0.125f , 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,  1.440625f, 0.125f, 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a, 1.440625f, -0.125f,0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,-1.440625f, -0.125f, 0f);
                    poseStack.popPose();
    ...
    @Override
    public void preparePoseStack(x8par_lightblueBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
