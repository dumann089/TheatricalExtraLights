...
public class BlinderRenderer extends ExtraLightsRenderer<BlinderBlockEntity> {
    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;
    public BlinderRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(BlinderBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
//        poseStack.mulPose(Axis.XP.rotationDegrees(180));
    ...
    public void beforeRenderBeam(
            BlinderBlockEntity blockEntity,
            PoseStack poseStack,
            ...
            LazyRenderers.addLazyRender(new LazyRenderers.LazyRenderer() {
                ...
                public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                    ...
                    BlinderRenderHelper.renderFace(
                            ...
                            poseStack,
                            partialTick,
                            BlinderRenderHelper.FaceQuad.STANDARD
                    );
                    poseStack.popPose();
                }
                @Override
    ...
    @Override
    public void preparePoseStack(BlinderBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
