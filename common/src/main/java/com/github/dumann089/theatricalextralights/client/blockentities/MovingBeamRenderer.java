...
public class MovingBeamRenderer extends ExtraLightsFixtureRenderer<MovingBeamBlockEntity> {
    ...
    public MovingBeamRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(MovingBeamBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            MovingBeamBlockEntity blockEntity, PoseStack basePoseStack, VertexConsumer vertexConsumer,
