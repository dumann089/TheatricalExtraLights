...
public class par56_magentaBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {

    private final int fixedGobo = 0;
    private final int fixedZoom = 255;
    private final float fixedGoboRotation = 0f;

    public par56_magentaBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.PAR56_MAGENTA.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public Fixture getFixture() {
        return Fixtures.PAR56_MAGENTA.get();
    }
    ...
    @Override
    public String getModelName() { return "Par56 Magenta"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_MAGENTA.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.par56_magenta"; }
