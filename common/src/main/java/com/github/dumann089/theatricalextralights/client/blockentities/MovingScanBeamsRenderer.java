...
public class MovingScanBeamsRenderer extends ExtraLightsFixtureRenderer<MovingScanBeamsBlockEntity> {
    ...
    @Override
    public void renderModel(MovingScanBeamsBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
