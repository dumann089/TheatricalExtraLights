...
public class Par1000PurpleRenderer extends ExtraLightsFixtureRenderer<Par1000PurpleBlockEntity> {
    ...
    public Par1000PurpleRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(Par1000PurpleBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            Par1000PurpleBlockEntity blockEntity,
            PoseStack poseStack,
