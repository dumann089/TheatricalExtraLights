...
public class MacVipRenderer extends ExtraLightsFixtureRenderer<MacVipBlockEntity> {
    ...
    public MacVipRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(MacVipBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            MacVipBlockEntity blockEntity, PoseStack basePoseStack, VertexConsumer vertexConsumer,
