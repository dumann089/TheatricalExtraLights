...
import com.github.dumann089.theatricalextralights.blockentities.truss3lightsBlockEntity;
...
public class truss3lightsRenderer extends ExtraLightsRenderer<truss3lightsBlockEntity> {
    private BakedModel cachedPanModel, cachedTiltModel, cachedStaticModel;
    public truss3lightsRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(truss3lightsBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
...
//        poseStack.mulPose(Axis.XP.rotationDegrees(180));
    ...
    @Override
    public void beforeRenderBeam(truss3lightsBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.5, 0.5f, 0.109f);
                    Matrix4f m = poseStack.last().pose();
                    Matrix3f normal = poseStack.last().normal();
                    addVertex(beamConsumer, m, normal, r, g, b, a, -1.25f, 1.25f , 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,  1.25f, 1.25f, 0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a, 1.25f, -1.25f,0f);
                    addVertex(beamConsumer, m, normal, r, g, b, a,-1.25f, -1.25f, 0f);
                    poseStack.popPose();
