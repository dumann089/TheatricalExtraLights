...
public class par56_greenBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {
    ...
    public par56_greenBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.PAR56_GREEN.get(), pos, state);
    ...
    public Fixture getFixture() {
        return Fixtures.PAR56_GREEN.get();
    }
    ...
    @Override
    public String getModelName() { return "Par56 Green"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_GREEN.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.par56_green"; }
