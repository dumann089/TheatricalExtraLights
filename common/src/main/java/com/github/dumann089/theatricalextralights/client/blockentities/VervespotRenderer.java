...
public class VervespotRenderer extends ExtraLightsFixtureRenderer<VervespotBlockEntity> {
    ...
    public VervespotRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(VervespotBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    private static final Vec3 LENS_OFFSET = new Vec3(0.5f, 1.225f, -0.38f);
    private static final float MIN_ANGLE_DEG = 1.0f;
    private static final float MAX_ANGLE_DEG = 15.0f;

    @Override
    public void beforeRenderBeam(
            VervespotBlockEntity blockEntity, PoseStack basePoseStack, VertexConsumer vertexConsumer,
        ...
        LazyRenderers.addLazyRender(new LazyRenderers.LazyRenderer() {
            ...
            public void render(MultiBufferSource.BufferSource bufferSource, PoseStack poseStack, Camera camera, float partialTick) {
                ...
                renderLens(bufferSource, poseStack, alpha, color, 0.22f, (float) LENS_OFFSET.x, (float) LENS_OFFSET.y, (float) LENS_OFFSET.z);
                poseStack.popPose();
            }
    ...
    @Override
    public void preparePoseStack(VervespotBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
