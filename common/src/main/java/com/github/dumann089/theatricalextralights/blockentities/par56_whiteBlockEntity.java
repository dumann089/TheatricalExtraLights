...
public class par56_whiteBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {

    private final int fixedGobo = 0;
    private final int fixedZoom = 255;
    private final float fixedGoboRotation = 0f;

    public par56_whiteBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.PAR56_WHITE.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public Fixture getFixture() {
        return Fixtures.PAR56_WHITE.get();
    }
    ...
    @Override
    public String getModelName() { return "Par56 White"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_WHITE.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.PAR56_WHITE"; }
