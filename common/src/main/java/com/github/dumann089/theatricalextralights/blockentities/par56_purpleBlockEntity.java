...
public class par56_purpleBlockEntity extends ExtraLightsLightBlockEntity implements HasGobo {

    private final int fixedGobo = 0;
    private final int fixedZoom = 255;
    private final float fixedGoboRotation = 0f;

    public par56_purpleBlockEntity(BlockPos pos, BlockState state) {
        super(BlockEntities.PAR56_PURPLE.get(), pos, state);
        setChannelCount(1);
    }
    ...
    public Fixture getFixture() {
        return Fixtures.PAR56_PURPLE.get();
    }
    ...
    @Override
    public String getModelName() { return "Par56 Purple"; }

    @Override
    public ResourceLocation getFixtureId() { return Fixtures.PAR56_PURPLE.getId(); }
    ...
    @Override
    public String getTranslationKey() { return "block.theatricalextralights.par56_purple"; }
