...
public class AtomictiltRenderer extends ExtraLightsRenderer<AtomictiltBlockEntity> {
    ...
    @Override
    public void renderModel(AtomictiltBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    @Override
    public void beforeRenderBeam(AtomictiltBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, MultiBufferSource multiBufferSource, Direction facing, float partialTicks, boolean isFlipped, BlockState blockstate, boolean isHanging, int packedLight, int packedOverlay) {
...
//            poseStack.translate(blockEntity.getFixture().getBeamStartPosition()[0], blockEntity.getFixture().getBeamStartPosition()[1], blockEntity.getFixture().getBeamStartPosition()[2]);
                    ...
                    poseStack.translate(0.509F, 0.573F, 0.346F);
                    Matrix4f m = poseStack.last().pose();
                    Matrix3f normal = poseStack.last().normal();
                    addVertex(beamConsumer, m, normal, r, g, b, a, -0.3828125f,  0.25f, 0f);  // Top Left
                    addVertex(beamConsumer, m, normal, r, g, b, a,  0.3828125f,  0.25f, 0f);  // Top Right
                    addVertex(beamConsumer, m, normal, r, g, b, a,  0.3828125f, -0.25f, 0f);  // Bottom Right
                    addVertex(beamConsumer, m, normal, r, g, b, a, -0.3828125f, -0.25f, 0f);  // Bottom Left
                    poseStack.popPose();
                }
