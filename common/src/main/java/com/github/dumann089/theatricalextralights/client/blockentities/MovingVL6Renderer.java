...
import com.github.dumann089.theatricalextralights.blockentities.MovingVL6BlockEntity;
...
public class MovingVL6Renderer extends ExtraLightsFixtureRenderer<MovingVL6BlockEntity> {
    ...
    public MovingVL6Renderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(MovingVL6BlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
    ...
    public void beforeRenderBeam(
            MovingVL6BlockEntity blockEntity, PoseStack basePoseStack, VertexConsumer vertexConsumer,
