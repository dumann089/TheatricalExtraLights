...
import com.github.dumann089.theatricalextralights.blockentities.CakeWaterJetBlockEntity;
...
public class CakeWaterJetRenderer extends ExtraLightsRenderer<CakeWaterJetBlockEntity> {
    ...
    public CakeWaterJetRenderer(BlockEntityRendererProvider.Context context) {
        super(context);
    }

    @Override
    public void renderModel(CakeWaterJetBlockEntity blockEntity, PoseStack poseStack, VertexConsumer vertexConsumer, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging, int packedLight, int packedOverlay) {
        ...
        @Override
    public void preparePoseStack(CakeWaterJetBlockEntity blockEntity, PoseStack poseStack, Direction facing, float partialTicks, boolean isFlipped, BlockState blockState, boolean isHanging) {
